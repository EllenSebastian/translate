dictionary = {
	...
	u"l'amendement": ["amendment"],
	u"3": ["3"],
	u"parce": ["because"],
	u"que": ["that", "than", "whether", "which", "what", "whom", "how"],
	u"grand": ["large", "great", "big", "wide", "broad", "spacious", "high", "tall", "loud", "full grown", "roomy", "substantial", "noble", "good", "goodly"],
	u"mère": ["mother", "parent", "mom", "mum", "mama", "ma", "mummy"],
	u"allemande": ["German"],
	...
	u"bulgare": ["Bulgarian"],
	u"n'envisagerait": ["would consider"],
	u"même": ["same", "even", "actual", "selfsame", "yet", "alike", "nay"],
	u"voter": ["vote", "cast a vote", "poll"],
	u"traité": ["treaty", "treatise", "processed", "accord", "pact", "convention", "disquisition"],
	u"d'adhésion": ["membership"],
	...
	u"rejets": ["releases"],
	u"produire": ["produce", "generate", "cause", "manufacture", "output", "grow", "turn out", "crank out", "put forth", "issue", "bring forward", "carry"],
	...
	u'divers': ['various', 'diverse', 'miscellaneous', 'several', 'varied', 'variant', 'manifold', 'varicoloured', 'varicolored', 'sundry', 'multifarious'],
