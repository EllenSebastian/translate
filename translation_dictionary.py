...
vocab = {
  ...
  u"députés": ["deputy", "member of parliament", "congressman", "representative", "burgess", "delegate"],
  ...
  u"citoyennes": ["people"],
  u"Union": ["Union"],
  u"propose": ["propose", "offer", "suggest", "move", "nominate", "hold out", "propound", "slate"],
  u"on": ["one"],
  ...
  u'voteront': ["vote", "cast a vote", "poll"],
  ...
  u"homosexuels": ["homosexual", "gay", "queer"],
  u"Bulgarie": ["Bulgaria"],
  u"devait": ["was"],
  ...
  u"prochaines": ["next", "upcoming", "forthcoming"],
  u"décennies": ["decade", "decennary", "decennium"],
  u"augmentations": ["increase", "gain", "rise", "boost", "growth", "increment", "advance", "augmentation", "augment", "raise", "enhancement", "accession", "build-up", "expansion", "surge", "swell"],
  u"fortes": ["strong", "hard", "stout", "large", "heavy", "great", "big", "loud", "broad", "intense", "fierce", "potent"],
  u"rejets": ["releases"],
  ...
  u'projets': ['project', 'plan', 'design', 'idea', 'scheme', 'schema', 'blueprint', 'venture', 'business', 'topic'],
  u'communs': ['join', 'common', 'mutual', 'shared', 'communal', 'common-or-garden', 'normal', 'rife'],
  ...
  u'zones': ['area', 'zone', 'region', 'box', 'belt', 'pool'],
  ...
  u'instruments': ['instrument', 'tool', 'appliance', 'cradle', 'implement'],
  u'qui': ['which', 'that', 'who', 'whom'],
  ...
  u'marchés': ['market', 'market place', 'mart', 'emporium', 'bargain'],
  u'capitaux': ['capital', 'fund'],
  u'il': ['it', 'he'],
  u'Européens': ['European'],
}
